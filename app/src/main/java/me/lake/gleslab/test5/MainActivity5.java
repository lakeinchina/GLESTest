...
public class MainActivity5 extends AppCompatActivity implements TextureView.SurfaceTextureListener, SurfaceTexture.OnFrameAvailableListener {
    int w = 1280;
    int h = 720;
    TextureView txv_image;
    ScreenRenderThread5 screenRenderThread;
    int textureId;
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        screenRenderThread = new ScreenRenderThread5(this, textureId, camTexture, surface);
